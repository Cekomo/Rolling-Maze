...
public class SwipeDetection : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (fingerDown)
        {
            ...
            if (!isForward && Input.mousePosition.x <= startPos.x - pixelDistToDetect)
            {
                fingerDown = false;
                //Debug.Log("Swipe Left!");
            ...
            else if (!isForward && Input.mousePosition.x >= startPos.x + pixelDistToDetect)
            {
                fingerDown = false;
                //Debug.Log("Swipe Right!");
            ...
            else if (Input.GetMouseButton(0) && Input.mousePosition.x == startPos.x)
                isForward = true;
